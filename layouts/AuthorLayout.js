        ...
        <div className="items-start space-y-2 xl:grid xl:grid-cols-3 xl:gap-x-8 xl:space-y-0">
          <div className="flex flex-col items-center space-x-2 pt-8 xl:sticky xl:top-0">
            <Image
              ...
              placeholder="blur"
              blurDataURL="/static/images/DP.jpg" // to be changed to amar'sir image -by spiddy
            />
          ...
          <div className="prose max-w-none pt-8 pb-8 dark:prose-dark xl:col-span-2">
            <p>
              ...
              >
                {text1} Currently, I am focused on Researching intelligent solution to counter
                Stubble Burning At{' '}
                <Link
                  href={'http://cs.sliet.ac.in/people/amarnath/'}
            ...
            <p className="sm:block md:hidden lg:hidden">
              ...
              <span className="font-semibold">
                {' '}
                Distributed Systems, Machine Learning and Deep Learning.{' '}
              </span>
              ...
              <RoughNotation
                ...
                multiline={true}
              >
                actively on the lookout for Enthusiastic Researchers to Collaborate with.
              </RoughNotation>
            </p>
            ...
            <p>
              ...
              <Link
                href={'mailto:amarnath@sliet.ac.in'}
                className="special-underline no-underline hover:text-gray-100 dark:text-gray-100 hover:dark:text-gray-100"
              >
                Mail
                <svg
              ...
              or{' '}
              <Link
                href={'https://api.whatsapp.com/send?phone=919917037538&text=hi'}
                className="special-underline no-underline hover:text-gray-100 dark:text-gray-100 hover:dark:text-gray-100"
              >
                Whatsapp
                <svg
