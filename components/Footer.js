  ...
  return (
    <footer>
      <div className="mt-10 flex flex-col items-center">
        <div className="">{/* <NowPlayingFooter /> */}</div>
        <div className="mb-2 hidden text-sm text-gray-500 dark:text-gray-400 md:flex">
          <div className="mx-1">
            <Link href="http://cs.sliet.ac.in/people/amarnath/" className="link-underline">
              Amar Nath{` © ${new Date().getFullYear()}`}
            </Link>
          </div>
          {`•`}
          <div className="mx-1">
